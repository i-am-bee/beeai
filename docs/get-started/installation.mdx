...
```
beeai env add MODEL=gpt-4o
beeai env add API_BASE=https://api.openai.com/v1
beeai env add API_KEY=sk_[...]
```
...
```
beeai env add MODEL=claude-3-7-sonnet-20250219
beeai env add API_BASE=https://api.anthropic.com/v1/
beeai env add API_KEY=[...]
```
...
```
beeai env add MODEL=deepseek-r1-distill-llama-70b
beeai env add API_BASE=https://api.groq.com/openai/v1
beeai env add API_KEY=gsk_[...]
```
...
```
beeai env add MODEL=llama3.3
beeai env add API_BASE=http://localhost:11434/v1
beeai env add API_KEY=ollama
```
...
```
beeai env add MODEL=google/gemini-2.0-pro-exp-02-05:free
beeai env add API_BASE=https://openrouter.ai/api/v1
beeai env add API_KEY=sk-or-v1-[...]
```
